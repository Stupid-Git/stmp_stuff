...
#ifndef _LAN8651_DRIVER_H
#define _LAN8651_DRIVER_H

//Dependencies
#include "core/nic.h"

//PLCA support
#ifndef LAN8651_PLCA_SUPPORT
   #define LAN8651_PLCA_SUPPORT ENABLED
#elif (LAN8651_PLCA_SUPPORT != ENABLED && LAN8651_PLCA_SUPPORT != DISABLED)
   #error LAN8651_PLCA_SUPPORT parameter is not valid
#endif

//Node count
#ifndef LAN8651_NODE_COUNT
   #define LAN8651_NODE_COUNT 8
#elif (LAN8651_NODE_COUNT < 0 || LAN8651_NODE_COUNT > 255)
   #error LAN8651_NODE_COUNT parameter is not valid
#endif

//Local ID
#ifndef LAN8651_LOCAL_ID
   #define LAN8651_LOCAL_ID 1
#elif (LAN8651_LOCAL_ID < 0 || LAN8651_LOCAL_ID > 255)
   #error LAN8651_LOCAL_ID parameter is not valid
#endif

//RX buffer size
#ifndef LAN8651_ETH_RX_BUFFER_SIZE
   #define LAN8651_ETH_RX_BUFFER_SIZE 1536
#elif (LAN8651_ETH_RX_BUFFER_SIZE != 1536)
   #error LAN8651_ETH_RX_BUFFER_SIZE parameter is not valid
#endif
...
//LAN8651 Open Alliance Standard registers (MMS 0)
...
//LAN8651 PHY PCS registers (MMS 2)
...
//LAN8651 PHY PMA/PMD registers (MMS 3)
...
//LAN8651 Vendor Specific registers (MMS 4)
...
//LAN8651 Miscellaneous registers (MMS 10)
...
//LAN8651 driver
extern const NicDriver lan8651Driver;

//LAN8651 related functions
