...
#define _ENC424J600_DRIVER_H

//Dependencies
#include "core/nic.h"

//RX buffer size
#ifndef ENC424J600_ETH_RX_BUFFER_SIZE
   #define ENC424J600_ETH_RX_BUFFER_SIZE 1536
#elif (ENC424J600_ETH_RX_BUFFER_SIZE != 1536)
   #error ENC424J600_ETH_RX_BUFFER_SIZE parameter is not valid
#endif
...
//SPI command set
#define ENC424J600_CMD_B0SEL       0xC0 //Bank 0 Select
#define ENC424J600_CMD_B1SEL       0xC2 //Bank 1 Select
#define ENC424J600_CMD_B2SEL       0xC4 //Bank 2 Select
#define ENC424J600_CMD_B3SEL       0xC6 //Bank 3 Select
#define ENC424J600_CMD_SETETHRST   0xCA //System Reset
#define ENC424J600_CMD_FCDISABLE   0xE0 //Flow Control Disable
#define ENC424J600_CMD_FCSINGLE    0xE2 //Flow Control Single
#define ENC424J600_CMD_FCMULTIPLE  0xE4 //Flow Control Multiple
#define ENC424J600_CMD_FCCLEAR     0xE6 //Flow Control Clear
#define ENC424J600_CMD_SETPKTDEC   0xCC //Decrement Packet Counter
#define ENC424J600_CMD_DMASTOP     0xD2 //DMA Stop
#define ENC424J600_CMD_DMACKSUM    0xD8 //DMA Start Checksum
#define ENC424J600_CMD_DMACKSUMS   0xDA //DMA Start Checksum with Seed
#define ENC424J600_CMD_DMACOPY     0xDC //DMA Start Copy
#define ENC424J600_CMD_DMACOPYS    0xDE //DMA Start Copy and Checksum with Seed
#define ENC424J600_CMD_SETTXRTS    0xD4 //Request Packet Transmission
#define ENC424J600_CMD_ENABLERX    0xE8 //Enable RX
#define ENC424J600_CMD_DISABLERX   0xEA //Disable RX
#define ENC424J600_CMD_SETEIE      0xEC //Enable Interrupts
#define ENC424J600_CMD_CLREIE      0xEE //Disable Interrupts
#define ENC424J600_CMD_RBSEL       0xC8 //Read Bank Select
#define ENC424J600_CMD_WGPRDPT     0x60 //Write EGPRDPT
#define ENC424J600_CMD_RGPRDPT     0x62 //Read EGPRDPT
#define ENC424J600_CMD_WRXRDPT     0x64 //Write ERXRDPT
#define ENC424J600_CMD_RRXRDPT     0x66 //Read ERXRDPT
#define ENC424J600_CMD_WUDARDPT    0x68 //Write EUDARDPT
#define ENC424J600_CMD_RUDARDPT    0x6A //Read EUDARDPT
#define ENC424J600_CMD_WGPWRPT     0x6C //Write EGPWRPT
#define ENC424J600_CMD_RGPWRPT     0x6E //Read EGPWRPT
#define ENC424J600_CMD_WRXWRPT     0x70 //Write ERXWRPT
#define ENC424J600_CMD_RRXWRPT     0x72 //Read ERXWRPT
#define ENC424J600_CMD_WUDAWRPT    0x74 //Write EUDAWRPT
#define ENC424J600_CMD_RUDAWRPT    0x76 //Read EUDAWRPT
#define ENC424J600_CMD_RCR         0x00 //Read Control Register
#define ENC424J600_CMD_WCR         0x40 //Write Control Register
#define ENC424J600_CMD_RCRU        0x20 //Read Control Register Unbanked
#define ENC424J600_CMD_WCRU        0x22 //Write Control Register Unbanked
#define ENC424J600_CMD_BFS         0x80 //Bit Field Set
#define ENC424J600_CMD_BFC         0xA0 //Bit Field Clear
#define ENC424J600_CMD_BFSU        0x24 //Bit Field Set Unbanked
#define ENC424J600_CMD_BFCU        0x26 //Bit Field Clear Unbanked
#define ENC424J600_CMD_RGPDATA     0x28 //Read EGPDATA
#define ENC424J600_CMD_WGPDATA     0x2A //Write EGPDATA
#define ENC424J600_CMD_RRXDATA     0x2C //Read ERXDATA
#define ENC424J600_CMD_WRXDATA     0x2E //Write ERXDATA
#define ENC424J600_CMD_RUDADATA    0x30 //Read EUDADATA
#define ENC424J600_CMD_WUDADATA    0x32 //Write EUDADATA
...
/**
 * @brief ENC424J600 driver context
 **/
...
//ENC424J600 driver
extern const NicDriver enc424j600Driver;
