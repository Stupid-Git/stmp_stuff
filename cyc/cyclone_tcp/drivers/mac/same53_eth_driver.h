...
//Number of TX buffers
   ...
   #define SAME53_ETH_TX_BUFFER_COUNT 3
#elif (SAME53_ETH_TX_BUFFER_COUNT < 1)
   #error SAME53_ETH_TX_BUFFER_COUNT parameter is not valid
#endif

//TX buffer size
#ifndef SAME53_ETH_TX_BUFFER_SIZE
   #define SAME53_ETH_TX_BUFFER_SIZE 1536
#elif (SAME53_ETH_TX_BUFFER_SIZE != 1536)
   #error SAME53_ETH_TX_BUFFER_SIZE parameter is not valid
#endif

//Number of RX buffers
#ifndef SAME53_ETH_RX_BUFFER_COUNT
   #define SAME53_ETH_RX_BUFFER_COUNT 72
#elif (SAME53_ETH_RX_BUFFER_COUNT < 12)
   #error SAME53_ETH_RX_BUFFER_COUNT parameter is not valid
#endif

//RX buffer size
#ifndef SAME53_ETH_RX_BUFFER_SIZE
   #define SAME53_ETH_RX_BUFFER_SIZE 128
#elif (SAME53_ETH_RX_BUFFER_SIZE != 128)
   #error SAME53_ETH_RX_BUFFER_SIZE parameter is not valid
#endif

//Interrupt priority grouping
#ifndef SAME53_ETH_IRQ_PRIORITY_GROUPING
   #define SAME53_ETH_IRQ_PRIORITY_GROUPING 4
#elif (SAME53_ETH_IRQ_PRIORITY_GROUPING < 0)
   #error SAME53_ETH_IRQ_PRIORITY_GROUPING parameter is not valid
#endif

//Ethernet interrupt group priority
#ifndef SAME53_ETH_IRQ_GROUP_PRIORITY
   #define SAME53_ETH_IRQ_GROUP_PRIORITY 6
#elif (SAME53_ETH_IRQ_GROUP_PRIORITY < 0)
   #error SAME53_ETH_IRQ_GROUP_PRIORITY parameter is not valid
#endif

//Ethernet interrupt subpriority
#ifndef SAME53_ETH_IRQ_SUB_PRIORITY
   #define SAME53_ETH_IRQ_SUB_PRIORITY 0
#elif (SAME53_ETH_IRQ_SUB_PRIORITY < 0)
   #error SAME53_ETH_IRQ_SUB_PRIORITY parameter is not valid
#endif
...
extern const NicDriver same53EthDriver;

//SAME53 Ethernet MAC related functions
