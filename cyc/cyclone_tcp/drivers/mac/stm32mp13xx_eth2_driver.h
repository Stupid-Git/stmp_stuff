/**
 * @file stm32mp13xx_eth2_driver.h
...
#ifndef _STM32MP13XX_ETH2_DRIVER_H
#define _STM32MP13XX_ETH2_DRIVER_H

//Dependencies
#include "core/nic.h"

//Number of TX buffers
#ifndef STM32MP13XX_ETH2_TX_BUFFER_COUNT
   #define STM32MP13XX_ETH2_TX_BUFFER_COUNT 8
#elif (STM32MP13XX_ETH2_TX_BUFFER_COUNT < 1)
   #error STM32MP13XX_ETH2_TX_BUFFER_COUNT parameter is not valid
#endif

//TX buffer size
#ifndef STM32MP13XX_ETH2_TX_BUFFER_SIZE
   #define STM32MP13XX_ETH2_TX_BUFFER_SIZE 1536
#elif (STM32MP13XX_ETH2_TX_BUFFER_SIZE != 1536)
   #error STM32MP13XX_ETH2_TX_BUFFER_SIZE parameter is not valid
#endif

//Number of RX buffers
#ifndef STM32MP13XX_ETH2_RX_BUFFER_COUNT
   #define STM32MP13XX_ETH2_RX_BUFFER_COUNT 8
#elif (STM32MP13XX_ETH2_RX_BUFFER_COUNT < 1)
   #error STM32MP13XX_ETH2_RX_BUFFER_COUNT parameter is not valid
#endif

//RX buffer size
#ifndef STM32MP13XX_ETH2_RX_BUFFER_SIZE
   #define STM32MP13XX_ETH2_RX_BUFFER_SIZE 1536
#elif (STM32MP13XX_ETH2_RX_BUFFER_SIZE != 1536)
   #error STM32MP13XX_ETH2_RX_BUFFER_SIZE parameter is not valid
#endif

//Ethernet interrupt priority
#ifndef STM32MP13XX_ETH2_IRQ_PRIORITY
   #define STM32MP13XX_ETH2_IRQ_PRIORITY 25
#elif (STM32MP13XX_ETH2_IRQ_PRIORITY < 0)
   #error STM32MP13XX_ETH2_IRQ_PRIORITY parameter is not valid
#endif

//Name of the section where to place DMA buffers
#ifndef STM32MP13XX_ETH2_RAM_SECTION
   #define STM32MP13XX_ETH2_RAM_SECTION ".sysram"
#endif
