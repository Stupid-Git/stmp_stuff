...
#ifndef _FM3_ETH1_DRIVER_H
#define _FM3_ETH1_DRIVER_H

//Dependencies
#include "core/nic.h"

//Number of TX buffers
#ifndef FM3_ETH1_TX_BUFFER_COUNT
   #define FM3_ETH1_TX_BUFFER_COUNT 3
#elif (FM3_ETH1_TX_BUFFER_COUNT < 1)
   #error FM3_ETH1_TX_BUFFER_COUNT parameter is not valid
#endif

//TX buffer size
#ifndef FM3_ETH1_TX_BUFFER_SIZE
   #define FM3_ETH1_TX_BUFFER_SIZE 1536
#elif (FM3_ETH1_TX_BUFFER_SIZE != 1536)
   #error FM3_ETH1_TX_BUFFER_SIZE parameter is not valid
#endif

//Number of RX buffers
#ifndef FM3_ETH1_RX_BUFFER_COUNT
   #define FM3_ETH1_RX_BUFFER_COUNT 6
#elif (FM3_ETH1_RX_BUFFER_COUNT < 1)
   #error FM3_ETH1_RX_BUFFER_COUNT parameter is not valid
#endif

//RX buffer size
#ifndef FM3_ETH1_RX_BUFFER_SIZE
   #define FM3_ETH1_RX_BUFFER_SIZE 1536
#elif (FM3_ETH1_RX_BUFFER_SIZE != 1536)
   #error FM3_ETH1_RX_BUFFER_SIZE parameter is not valid
#endif

//Interrupt priority grouping
#ifndef FM3_ETH1_IRQ_PRIORITY_GROUPING
   #define FM3_ETH1_IRQ_PRIORITY_GROUPING 3
#elif (FM3_ETH1_IRQ_PRIORITY_GROUPING < 0)
   #error FM3_ETH1_IRQ_PRIORITY_GROUPING parameter is not valid
#endif

//Ethernet interrupt group priority
#ifndef FM3_ETH1_IRQ_GROUP_PRIORITY
   #define FM3_ETH1_IRQ_GROUP_PRIORITY 12
#elif (FM3_ETH1_IRQ_GROUP_PRIORITY < 0)
   #error FM3_ETH1_IRQ_GROUP_PRIORITY parameter is not valid
#endif

//Ethernet interrupt subpriority
#ifndef FM3_ETH1_IRQ_SUB_PRIORITY
   #define FM3_ETH1_IRQ_SUB_PRIORITY 0
#elif (FM3_ETH1_IRQ_SUB_PRIORITY < 0)
   #error FM3_ETH1_IRQ_SUB_PRIORITY parameter is not valid
#endif
...
extern const NicDriver fm3Eth1Driver;
