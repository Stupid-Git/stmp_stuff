...
#ifndef _STM32MP2XX_ETH2_DRIVER_H
#define _STM32MP2XX_ETH2_DRIVER_H

//Dependencies
#include "core/nic.h"

//Number of TX buffers
#ifndef STM32MP2XX_ETH2_TX_BUFFER_COUNT
   #define STM32MP2XX_ETH2_TX_BUFFER_COUNT 8
#elif (STM32MP2XX_ETH2_TX_BUFFER_COUNT < 1)
   #error STM32MP2XX_ETH2_TX_BUFFER_COUNT parameter is not valid
#endif

//TX buffer size
#ifndef STM32MP2XX_ETH2_TX_BUFFER_SIZE
   #define STM32MP2XX_ETH2_TX_BUFFER_SIZE 1536
#elif (STM32MP2XX_ETH2_TX_BUFFER_SIZE != 1536)
   #error STM32MP2XX_ETH2_TX_BUFFER_SIZE parameter is not valid
#endif

//Number of RX buffers
#ifndef STM32MP2XX_ETH2_RX_BUFFER_COUNT
   #define STM32MP2XX_ETH2_RX_BUFFER_COUNT 8
#elif (STM32MP2XX_ETH2_RX_BUFFER_COUNT < 1)
   #error STM32MP2XX_ETH2_RX_BUFFER_COUNT parameter is not valid
#endif

//RX buffer size
#ifndef STM32MP2XX_ETH2_RX_BUFFER_SIZE
   #define STM32MP2XX_ETH2_RX_BUFFER_SIZE 1536
#elif (STM32MP2XX_ETH2_RX_BUFFER_SIZE != 1536)
   #error STM32MP2XX_ETH2_RX_BUFFER_SIZE parameter is not valid
#endif

//Interrupt priority grouping
#ifndef STM32MP2XX_ETH2_IRQ_PRIORITY_GROUPING
   #define STM32MP2XX_ETH2_IRQ_PRIORITY_GROUPING 3
#elif (STM32MP2XX_ETH2_IRQ_PRIORITY_GROUPING < 0)
   #error STM32MP2XX_ETH2_IRQ_PRIORITY_GROUPING parameter is not valid
#endif

//Ethernet interrupt group priority
#ifndef STM32MP2XX_ETH2_IRQ_GROUP_PRIORITY
   #define STM32MP2XX_ETH2_IRQ_GROUP_PRIORITY 12
#elif (STM32MP2XX_ETH2_IRQ_GROUP_PRIORITY < 0)
   #error STM32MP2XX_ETH2_IRQ_GROUP_PRIORITY parameter is not valid
#endif

//Ethernet interrupt subpriority
#ifndef STM32MP2XX_ETH2_IRQ_SUB_PRIORITY
   #define STM32MP2XX_ETH2_IRQ_SUB_PRIORITY 0
#elif (STM32MP2XX_ETH2_IRQ_SUB_PRIORITY < 0)
   #error STM32MP2XX_ETH2_IRQ_SUB_PRIORITY parameter is not valid
#endif
...
typedef struct
{
   ...
   uint32_t rdes2;
   uint32_t rdes3;
} Stm32mp2xxEth2RxDmaDesc;


//STM32MP2 Ethernet MAC driver (ETH2 instance)
extern const NicDriver stm32mp2xxEth2Driver;
