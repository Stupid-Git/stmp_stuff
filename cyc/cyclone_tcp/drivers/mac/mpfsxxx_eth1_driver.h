...
#define _MPFSXXX_ETH1_DRIVER_H

//Number of TX buffers
#ifndef MPFSXXX_ETH1_TX_BUFFER_COUNT
   #define MPFSXXX_ETH1_TX_BUFFER_COUNT 16
#elif (MPFSXXX_ETH1_TX_BUFFER_COUNT < 1)
   #error MPFSXXX_ETH1_TX_BUFFER_COUNT parameter is not valid
#endif

//TX buffer size
#ifndef MPFSXXX_ETH1_TX_BUFFER_SIZE
   #define MPFSXXX_ETH1_TX_BUFFER_SIZE 1536
#elif (MPFSXXX_ETH1_TX_BUFFER_SIZE != 1536)
   #error MPFSXXX_ETH1_TX_BUFFER_SIZE parameter is not valid
#endif

//Number of RX buffers
#ifndef MPFSXXX_ETH1_RX_BUFFER_COUNT
   #define MPFSXXX_ETH1_RX_BUFFER_COUNT 16
#elif (MPFSXXX_ETH1_RX_BUFFER_COUNT < 12)
   #error MPFSXXX_ETH1_RX_BUFFER_COUNT parameter is not valid
#endif

//RX buffer size
#ifndef MPFSXXX_ETH1_RX_BUFFER_SIZE
   #define MPFSXXX_ETH1_RX_BUFFER_SIZE 1536
#elif (MPFSXXX_ETH1_RX_BUFFER_SIZE != 1536)
   #error MPFSXXX_ETH1_RX_BUFFER_SIZE parameter is not valid
#endif

//Number of dummy buffers
#ifndef MPFSXXX_ETH1_DUMMY_BUFFER_COUNT
   #define MPFSXXX_ETH1_DUMMY_BUFFER_COUNT 2
#elif (MPFSXXX_ETH1_DUMMY_BUFFER_COUNT < 1)
   #error MPFSXXX_ETH1_DUMMY_BUFFER_COUNT parameter is not valid
#endif

//Dummy buffer size
#ifndef MPFSXXX_ETH1_DUMMY_BUFFER_SIZE
   #define MPFSXXX_ETH1_DUMMY_BUFFER_SIZE 128
#elif (MPFSXXX_ETH1_DUMMY_BUFFER_SIZE != 128)
   #error MPFSXXX_ETH1_DUMMY_BUFFER_SIZE parameter is not valid
#endif

//Ethernet interrupt priority
#ifndef MPFSXXX_ETH1_IRQ_PRIORITY
   #define MPFSXXX_ETH1_IRQ_PRIORITY 7
#elif (MPFSXXX_ETH1_IRQ_PRIORITY < 0)
   #error MPFSXXX_ETH1_IRQ_PRIORITY parameter is not valid
#endif

//Name of the section where to place DMA buffers
#ifndef MPFSXXX_ETH1_RAM_SECTION
...
typedef struct
{
   ...
   uint32_t nanoSeconds;
   uint32_t seconds;
} MpfsxxxEth1RxBufferDesc;


//MPFSxxx Ethernet MAC driver (MAC0 instance)
extern const NicDriver mpfsxxxEth1Driver;
