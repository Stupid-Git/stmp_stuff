...
#ifndef _RX65N_ETH_DRIVER_H
#define _RX65N_ETH_DRIVER_H

//Dependencies
#include "core/nic.h"

//Number of TX buffers
#ifndef RX65N_ETH_TX_BUFFER_COUNT
   #define RX65N_ETH_TX_BUFFER_COUNT 3
#elif (RX65N_ETH_TX_BUFFER_COUNT < 1)
   #error RX65N_ETH_TX_BUFFER_COUNT parameter is not valid
#endif

//TX buffer size
#ifndef RX65N_ETH_TX_BUFFER_SIZE
   #define RX65N_ETH_TX_BUFFER_SIZE 1536
#elif (RX65N_ETH_TX_BUFFER_SIZE != 1536)
   #error RX65N_ETH_TX_BUFFER_SIZE parameter is not valid
#endif

//Number of RX buffers
#ifndef RX65N_ETH_RX_BUFFER_COUNT
   #define RX65N_ETH_RX_BUFFER_COUNT 6
#elif (RX65N_ETH_RX_BUFFER_COUNT < 1)
   #error RX65N_ETH_RX_BUFFER_COUNT parameter is not valid
#endif

//RX buffer size
#ifndef RX65N_ETH_RX_BUFFER_SIZE
   #define RX65N_ETH_RX_BUFFER_SIZE 1536
#elif (RX65N_ETH_RX_BUFFER_SIZE != 1536)
   #error RX65N_ETH_RX_BUFFER_SIZE parameter is not valid
#endif

//Ethernet interrupt priority
#ifndef RX65N_ETH_IRQ_PRIORITY
   #define RX65N_ETH_IRQ_PRIORITY 2
#elif (RX65N_ETH_IRQ_PRIORITY < 0)
   #error RX65N_ETH_IRQ_PRIORITY parameter is not valid
#endif
...
extern const NicDriver rx65nEthDriver;

//RX65N Ethernet MAC related functions
