...
#ifndef _STM32MP2XX_ETH1_DRIVER_H
#define _STM32MP2XX_ETH1_DRIVER_H

//Dependencies
#include "core/nic.h"

//Number of TX buffers
#ifndef STM32MP2XX_ETH1_TX_BUFFER_COUNT
   #define STM32MP2XX_ETH1_TX_BUFFER_COUNT 8
#elif (STM32MP2XX_ETH1_TX_BUFFER_COUNT < 1)
   #error STM32MP2XX_ETH1_TX_BUFFER_COUNT parameter is not valid
#endif

//TX buffer size
#ifndef STM32MP2XX_ETH1_TX_BUFFER_SIZE
   #define STM32MP2XX_ETH1_TX_BUFFER_SIZE 1536
#elif (STM32MP2XX_ETH1_TX_BUFFER_SIZE != 1536)
   #error STM32MP2XX_ETH1_TX_BUFFER_SIZE parameter is not valid
#endif

//Number of RX buffers
#ifndef STM32MP2XX_ETH1_RX_BUFFER_COUNT
   #define STM32MP2XX_ETH1_RX_BUFFER_COUNT 8
#elif (STM32MP2XX_ETH1_RX_BUFFER_COUNT < 1)
   #error STM32MP2XX_ETH1_RX_BUFFER_COUNT parameter is not valid
#endif

//RX buffer size
#ifndef STM32MP2XX_ETH1_RX_BUFFER_SIZE
   #define STM32MP2XX_ETH1_RX_BUFFER_SIZE 1536
#elif (STM32MP2XX_ETH1_RX_BUFFER_SIZE != 1536)
   #error STM32MP2XX_ETH1_RX_BUFFER_SIZE parameter is not valid
#endif

//Interrupt priority grouping
#ifndef STM32MP2XX_ETH1_IRQ_PRIORITY_GROUPING
   #define STM32MP2XX_ETH1_IRQ_PRIORITY_GROUPING 3
#elif (STM32MP2XX_ETH1_IRQ_PRIORITY_GROUPING < 0)
   #error STM32MP2XX_ETH1_IRQ_PRIORITY_GROUPING parameter is not valid
#endif

//Ethernet interrupt group priority
#ifndef STM32MP2XX_ETH1_IRQ_GROUP_PRIORITY
   #define STM32MP2XX_ETH1_IRQ_GROUP_PRIORITY 12
#elif (STM32MP2XX_ETH1_IRQ_GROUP_PRIORITY < 0)
   #error STM32MP2XX_ETH1_IRQ_GROUP_PRIORITY parameter is not valid
#endif

//Ethernet interrupt subpriority
#ifndef STM32MP2XX_ETH1_IRQ_SUB_PRIORITY
   #define STM32MP2XX_ETH1_IRQ_SUB_PRIORITY 0
#elif (STM32MP2XX_ETH1_IRQ_SUB_PRIORITY < 0)
   #error STM32MP2XX_ETH1_IRQ_SUB_PRIORITY parameter is not valid
#endif
...
#define ETH_DMAMR_TXPR_Val(n)       (((n) << ETH_DMAMR_TXPR_Pos) & ETH_DMAMR_TXPR_Msk)
...
typedef struct
{
   ...
   uint32_t rdes2;
   uint32_t rdes3;
} Stm32mp2xxEth1RxDmaDesc;


//STM32MP2 Ethernet MAC driver (ETH1 instance)
extern const NicDriver stm32mp2xxEth1Driver;

//STM32MP2 Ethernet MAC related functions
error_t stm32mp2xxEth1Init(NetInterface *interface);
void stm32mp2xxEth1InitGpio(NetInterface *interface);
