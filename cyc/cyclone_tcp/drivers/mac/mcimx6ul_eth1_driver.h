...
#define _MCIMX6UL_ETH1_DRIVER_H

//Number of TX buffers
#ifndef MCIMX6UL_ETH1_TX_BUFFER_COUNT
   #define MCIMX6UL_ETH1_TX_BUFFER_COUNT 8
#elif (MCIMX6UL_ETH1_TX_BUFFER_COUNT < 1)
   #error MCIMX6UL_ETH1_TX_BUFFER_COUNT parameter is not valid
#endif

//TX buffer size
#ifndef MCIMX6UL_ETH1_TX_BUFFER_SIZE
   #define MCIMX6UL_ETH1_TX_BUFFER_SIZE 1536
#elif (MCIMX6UL_ETH1_TX_BUFFER_SIZE != 1536)
   #error MCIMX6UL_ETH1_TX_BUFFER_SIZE parameter is not valid
#endif

//Number of RX buffers
#ifndef MCIMX6UL_ETH1_RX_BUFFER_COUNT
   #define MCIMX6UL_ETH1_RX_BUFFER_COUNT 8
#elif (MCIMX6UL_ETH1_RX_BUFFER_COUNT < 1)
   #error MCIMX6UL_ETH1_RX_BUFFER_COUNT parameter is not valid
#endif

//RX buffer size
#ifndef MCIMX6UL_ETH1_RX_BUFFER_SIZE
   #define MCIMX6UL_ETH1_RX_BUFFER_SIZE 1536
#elif (MCIMX6UL_ETH1_RX_BUFFER_SIZE != 1536)
   #error MCIMX6UL_ETH1_RX_BUFFER_SIZE parameter is not valid
#endif

//Ethernet interrupt priority
#ifndef MCIMX6UL_ETH1_IRQ_PRIORITY
   #define MCIMX6UL_ETH1_IRQ_PRIORITY 21
#elif (MCIMX6UL_ETH1_IRQ_PRIORITY < 0)
   #error MCIMX6UL_ETH1_IRQ_PRIORITY parameter is not valid
#endif

//Name of the section where to place DMA buffers
#ifndef MCIMX6UL_ETH1_RAM_SECTION
   #define MCIMX6UL_ETH1_RAM_SECTION "NonCacheable"
#endif
...
extern const NicDriver mcimx6ulEth1Driver;
