/**
 * @file stm32mp13xx_eth1_driver.h
...
#define _STM32MP13XX_ETH1_DRIVER_H

//Dependencies
#include "core/nic.h"

//Number of TX buffers
#ifndef STM32MP13XX_ETH1_TX_BUFFER_COUNT
   #define STM32MP13XX_ETH1_TX_BUFFER_COUNT 8
#elif (STM32MP13XX_ETH1_TX_BUFFER_COUNT < 1)
   #error STM32MP13XX_ETH1_TX_BUFFER_COUNT parameter is not valid
#endif

//TX buffer size
#ifndef STM32MP13XX_ETH1_TX_BUFFER_SIZE
   #define STM32MP13XX_ETH1_TX_BUFFER_SIZE 1536
#elif (STM32MP13XX_ETH1_TX_BUFFER_SIZE != 1536)
   #error STM32MP13XX_ETH1_TX_BUFFER_SIZE parameter is not valid
#endif

//Number of RX buffers
#ifndef STM32MP13XX_ETH1_RX_BUFFER_COUNT
   #define STM32MP13XX_ETH1_RX_BUFFER_COUNT 8
#elif (STM32MP13XX_ETH1_RX_BUFFER_COUNT < 1)
   #error STM32MP13XX_ETH1_RX_BUFFER_COUNT parameter is not valid
#endif

//RX buffer size
#ifndef STM32MP13XX_ETH1_RX_BUFFER_SIZE
   #define STM32MP13XX_ETH1_RX_BUFFER_SIZE 1536
#elif (STM32MP13XX_ETH1_RX_BUFFER_SIZE != 1536)
   #error STM32MP13XX_ETH1_RX_BUFFER_SIZE parameter is not valid
#endif

//Ethernet interrupt priority
#ifndef STM32MP13XX_ETH1_IRQ_PRIORITY
   #define STM32MP13XX_ETH1_IRQ_PRIORITY 25
#elif (STM32MP13XX_ETH1_IRQ_PRIORITY < 0)
   #error STM32MP13XX_ETH1_IRQ_PRIORITY parameter is not valid
#endif

//Name of the section where to place DMA buffers
#ifndef STM32MP13XX_ETH1_RAM_SECTION
   #define STM32MP13XX_ETH1_RAM_SECTION ".sysram"
#endif
...
typedef struct
{
   ...
   uint32_t rdes2;
   uint32_t rdes3;
} Stm32mp13xxEth1RxDmaDesc;


//STM32MP13 Ethernet MAC driver (ETH1 instance)
extern const NicDriver stm32mp13xxEth1Driver;
