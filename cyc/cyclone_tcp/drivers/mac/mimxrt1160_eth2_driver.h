...
#define _MIMXRT1160_ETH2_DRIVER_H

//Number of TX buffers
#ifndef MIMXRT1160_ETH2_TX_BUFFER_COUNT
   #define MIMXRT1160_ETH2_TX_BUFFER_COUNT 8
#elif (MIMXRT1160_ETH2_TX_BUFFER_COUNT < 1)
   #error MIMXRT1160_ETH2_TX_BUFFER_COUNT parameter is not valid
#endif

//TX buffer size
#ifndef MIMXRT1160_ETH2_TX_BUFFER_SIZE
   #define MIMXRT1160_ETH2_TX_BUFFER_SIZE 1536
#elif (MIMXRT1160_ETH2_TX_BUFFER_SIZE != 1536)
   #error MIMXRT1160_ETH2_TX_BUFFER_SIZE parameter is not valid
#endif

//Number of RX buffers
#ifndef MIMXRT1160_ETH2_RX_BUFFER_COUNT
   #define MIMXRT1160_ETH2_RX_BUFFER_COUNT 8
#elif (MIMXRT1160_ETH2_RX_BUFFER_COUNT < 1)
   #error MIMXRT1160_ETH2_RX_BUFFER_COUNT parameter is not valid
#endif

//RX buffer size
#ifndef MIMXRT1160_ETH2_RX_BUFFER_SIZE
   #define MIMXRT1160_ETH2_RX_BUFFER_SIZE 1536
#elif (MIMXRT1160_ETH2_RX_BUFFER_SIZE != 1536)
   #error MIMXRT1160_ETH2_RX_BUFFER_SIZE parameter is not valid
#endif

//Interrupt priority grouping
#ifndef MIMXRT1160_ETH2_IRQ_PRIORITY_GROUPING
   #define MIMXRT1160_ETH2_IRQ_PRIORITY_GROUPING 3
#elif (MIMXRT1160_ETH2_IRQ_PRIORITY_GROUPING < 0)
   #error MIMXRT1160_ETH2_IRQ_PRIORITY_GROUPING parameter is not valid
#endif

//Ethernet interrupt group priority
#ifndef MIMXRT1160_ETH2_IRQ_GROUP_PRIORITY
   #define MIMXRT1160_ETH2_IRQ_GROUP_PRIORITY 12
#elif (MIMXRT1160_ETH2_IRQ_GROUP_PRIORITY < 0)
   #error MIMXRT1160_ETH2_IRQ_GROUP_PRIORITY parameter is not valid
#endif

//Ethernet interrupt subpriority
#ifndef MIMXRT1160_ETH2_IRQ_SUB_PRIORITY
   #define MIMXRT1160_ETH2_IRQ_SUB_PRIORITY 0
#elif (MIMXRT1160_ETH2_IRQ_SUB_PRIORITY < 0)
   #error MIMXRT1160_ETH2_IRQ_SUB_PRIORITY parameter is not valid
#endif

//Name of the section where to place DMA buffers
#ifndef MIMXRT1160_ETH2_RAM_SECTION
   #define MIMXRT1160_ETH2_RAM_SECTION ".ram_no_cache"
#endif
...
//i.MX RT1160 Ethernet MAC driver (ENET_1G instance)
extern const NicDriver mimxrt1160Eth2Driver;

//i.MX RT1160 Ethernet MAC related functions
error_t mimxrt1160Eth2Init(NetInterface *interface);
void mimxrt1160Eth2InitGpio(NetInterface *interface);
