...
#ifndef _MPC5748_ETH1_DRIVER_H
#define _MPC5748_ETH1_DRIVER_H

//Number of TX buffers
#ifndef MPC5748_ETH1_TX_BUFFER_COUNT
   #define MPC5748_ETH1_TX_BUFFER_COUNT 3
#elif (MPC5748_ETH1_TX_BUFFER_COUNT < 1)
   #error MPC5748_ETH1_TX_BUFFER_COUNT parameter is not valid
#endif

//TX buffer size
#ifndef MPC5748_ETH1_TX_BUFFER_SIZE
   #define MPC5748_ETH1_TX_BUFFER_SIZE 1536
#elif (MPC5748_ETH1_TX_BUFFER_SIZE != 1536)
   #error MPC5748_ETH1_TX_BUFFER_SIZE parameter is not valid
#endif

//Number of RX buffers
#ifndef MPC5748_ETH1_RX_BUFFER_COUNT
   #define MPC5748_ETH1_RX_BUFFER_COUNT 6
#elif (MPC5748_ETH1_RX_BUFFER_COUNT < 1)
   #error MPC5748_ETH1_RX_BUFFER_COUNT parameter is not valid
#endif

//RX buffer size
#ifndef MPC5748_ETH1_RX_BUFFER_SIZE
   #define MPC5748_ETH1_RX_BUFFER_SIZE 1536
#elif (MPC5748_ETH1_RX_BUFFER_SIZE != 1536)
   #error MPC5748_ETH1_RX_BUFFER_SIZE parameter is not valid
#endif

//Ethernet interrupt priority
#ifndef MPC5748_ETH1_IRQ_PRIORITY
   #define MPC5748_ETH1_IRQ_PRIORITY 10
#elif (MPC5748_ETH1_IRQ_PRIORITY < 0)
   #error MPC5748_ETH1_IRQ_PRIORITY parameter is not valid
#endif
...
extern const NicDriver mpc5748Eth1Driver;
