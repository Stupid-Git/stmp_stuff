 ...
 * @brief Infineon XMC4700 Ethernet MAC driver
 *
 * @section License
 *
...
#pragma location = XMC4700_ETH_RAM_SECTION
...
//Transmit buffer
static uint8_t txBuffer[XMC4700_ETH_TX_BUFFER_COUNT][XMC4700_ETH_TX_BUFFER_SIZE]
   __attribute__((aligned(4), __section__(XMC4700_ETH_RAM_SECTION)));
//Receive buffer
static uint8_t rxBuffer[XMC4700_ETH_RX_BUFFER_COUNT][XMC4700_ETH_RX_BUFFER_SIZE]
   __attribute__((aligned(4), __section__(XMC4700_ETH_RAM_SECTION)));
//Transmit DMA descriptors
...
{
//XMC4700 Relax Kit?
#if defined(USE_KIT_XMC4700_RELAX)
   uint32_t temp;
