...
#ifndef _MIMXRT1040_ETH_DRIVER_H
#define _MIMXRT1040_ETH_DRIVER_H

//Number of TX buffers
#ifndef MIMXRT1040_ETH_TX_BUFFER_COUNT
   #define MIMXRT1040_ETH_TX_BUFFER_COUNT 8
#elif (MIMXRT1040_ETH_TX_BUFFER_COUNT < 1)
   #error MIMXRT1040_ETH_TX_BUFFER_COUNT parameter is not valid
#endif

//TX buffer size
#ifndef MIMXRT1040_ETH_TX_BUFFER_SIZE
   #define MIMXRT1040_ETH_TX_BUFFER_SIZE 1536
#elif (MIMXRT1040_ETH_TX_BUFFER_SIZE != 1536)
   #error MIMXRT1040_ETH_TX_BUFFER_SIZE parameter is not valid
#endif

//Number of RX buffers
#ifndef MIMXRT1040_ETH_RX_BUFFER_COUNT
   #define MIMXRT1040_ETH_RX_BUFFER_COUNT 8
#elif (MIMXRT1040_ETH_RX_BUFFER_COUNT < 1)
   #error MIMXRT1040_ETH_RX_BUFFER_COUNT parameter is not valid
#endif

//RX buffer size
#ifndef MIMXRT1040_ETH_RX_BUFFER_SIZE
   #define MIMXRT1040_ETH_RX_BUFFER_SIZE 1536
#elif (MIMXRT1040_ETH_RX_BUFFER_SIZE != 1536)
   #error MIMXRT1040_ETH_RX_BUFFER_SIZE parameter is not valid
#endif

//Interrupt priority grouping
#ifndef MIMXRT1040_ETH_IRQ_PRIORITY_GROUPING
   #define MIMXRT1040_ETH_IRQ_PRIORITY_GROUPING 3
#elif (MIMXRT1040_ETH_IRQ_PRIORITY_GROUPING < 0)
   #error MIMXRT1040_ETH_IRQ_PRIORITY_GROUPING parameter is not valid
#endif

//Ethernet interrupt group priority
#ifndef MIMXRT1040_ETH_IRQ_GROUP_PRIORITY
   #define MIMXRT1040_ETH_IRQ_GROUP_PRIORITY 12
#elif (MIMXRT1040_ETH_IRQ_GROUP_PRIORITY < 0)
   #error MIMXRT1040_ETH_IRQ_GROUP_PRIORITY parameter is not valid
#endif

//Ethernet interrupt subpriority
#ifndef MIMXRT1040_ETH_IRQ_SUB_PRIORITY
   #define MIMXRT1040_ETH_IRQ_SUB_PRIORITY 0
#elif (MIMXRT1040_ETH_IRQ_SUB_PRIORITY < 0)
   #error MIMXRT1040_ETH_IRQ_SUB_PRIORITY parameter is not valid
#endif

//Name of the section where to place DMA buffers
#ifndef MIMXRT1040_ETH_RAM_SECTION
   #define MIMXRT1040_ETH_RAM_SECTION ".ram_no_cache"
#endif
...
extern const NicDriver mimxrt1040EthDriver;

//i.MX RT1040 Ethernet MAC related functions
error_t mimxrt1040EthInit(NetInterface *interface);
void mimxrt1040EthInitGpio(NetInterface *interface);
