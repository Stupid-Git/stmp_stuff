...
#ifndef _STM32H5XX_ETH_DRIVER_H
#define _STM32H5XX_ETH_DRIVER_H

//Dependencies
#include "core/nic.h"

//Number of TX buffers
#ifndef STM32H5XX_ETH_TX_BUFFER_COUNT
   #define STM32H5XX_ETH_TX_BUFFER_COUNT 8
#elif (STM32H5XX_ETH_TX_BUFFER_COUNT < 1)
   #error STM32H5XX_ETH_TX_BUFFER_COUNT parameter is not valid
#endif

//TX buffer size
#ifndef STM32H5XX_ETH_TX_BUFFER_SIZE
   #define STM32H5XX_ETH_TX_BUFFER_SIZE 1536
#elif (STM32H5XX_ETH_TX_BUFFER_SIZE != 1536)
   #error STM32H5XX_ETH_TX_BUFFER_SIZE parameter is not valid
#endif

//Number of RX buffers
#ifndef STM32H5XX_ETH_RX_BUFFER_COUNT
   #define STM32H5XX_ETH_RX_BUFFER_COUNT 8
#elif (STM32H5XX_ETH_RX_BUFFER_COUNT < 1)
   #error STM32H5XX_ETH_RX_BUFFER_COUNT parameter is not valid
#endif

//RX buffer size
#ifndef STM32H5XX_ETH_RX_BUFFER_SIZE
   #define STM32H5XX_ETH_RX_BUFFER_SIZE 1536
#elif (STM32H5XX_ETH_RX_BUFFER_SIZE != 1536)
   #error STM32H5XX_ETH_RX_BUFFER_SIZE parameter is not valid
#endif

//Interrupt priority grouping
#ifndef STM32H5XX_ETH_IRQ_PRIORITY_GROUPING
   #define STM32H5XX_ETH_IRQ_PRIORITY_GROUPING 3
#elif (STM32H5XX_ETH_IRQ_PRIORITY_GROUPING < 0)
   #error STM32H5XX_ETH_IRQ_PRIORITY_GROUPING parameter is not valid
#endif

//Ethernet interrupt group priority
#ifndef STM32H5XX_ETH_IRQ_GROUP_PRIORITY
   #define STM32H5XX_ETH_IRQ_GROUP_PRIORITY 12
#elif (STM32H5XX_ETH_IRQ_GROUP_PRIORITY < 0)
   #error STM32H5XX_ETH_IRQ_GROUP_PRIORITY parameter is not valid
#endif

//Ethernet interrupt subpriority
#ifndef STM32H5XX_ETH_IRQ_SUB_PRIORITY
   #define STM32H5XX_ETH_IRQ_SUB_PRIORITY 0
#elif (STM32H5XX_ETH_IRQ_SUB_PRIORITY < 0)
   #error STM32H5XX_ETH_IRQ_SUB_PRIORITY parameter is not valid
#endif
...
extern const NicDriver stm32h5xxEthDriver;

//STM32H5 Ethernet MAC related functions
error_t stm32h5xxEthInit(NetInterface *interface);
void stm32h5xxEthInitGpio(NetInterface *interface);
