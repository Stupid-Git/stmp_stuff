...
#define _MIMXRT1020_ETH_DRIVER_H

//Number of TX buffers
#ifndef MIMXRT1020_ETH_TX_BUFFER_COUNT
   #define MIMXRT1020_ETH_TX_BUFFER_COUNT 3
#elif (MIMXRT1020_ETH_TX_BUFFER_COUNT < 1)
   #error MIMXRT1020_ETH_TX_BUFFER_COUNT parameter is not valid
#endif

//TX buffer size
#ifndef MIMXRT1020_ETH_TX_BUFFER_SIZE
   #define MIMXRT1020_ETH_TX_BUFFER_SIZE 1536
#elif (MIMXRT1020_ETH_TX_BUFFER_SIZE != 1536)
   #error MIMXRT1020_ETH_TX_BUFFER_SIZE parameter is not valid
#endif

//Number of RX buffers
#ifndef MIMXRT1020_ETH_RX_BUFFER_COUNT
   #define MIMXRT1020_ETH_RX_BUFFER_COUNT 6
#elif (MIMXRT1020_ETH_RX_BUFFER_COUNT < 1)
   #error MIMXRT1020_ETH_RX_BUFFER_COUNT parameter is not valid
#endif

//RX buffer size
#ifndef MIMXRT1020_ETH_RX_BUFFER_SIZE
   #define MIMXRT1020_ETH_RX_BUFFER_SIZE 1536
#elif (MIMXRT1020_ETH_RX_BUFFER_SIZE != 1536)
   #error MIMXRT1020_ETH_RX_BUFFER_SIZE parameter is not valid
#endif

//Interrupt priority grouping
#ifndef MIMXRT1020_ETH_IRQ_PRIORITY_GROUPING
   #define MIMXRT1020_ETH_IRQ_PRIORITY_GROUPING 3
#elif (MIMXRT1020_ETH_IRQ_PRIORITY_GROUPING < 0)
   #error MIMXRT1020_ETH_IRQ_PRIORITY_GROUPING parameter is not valid
#endif

//Ethernet interrupt group priority
#ifndef MIMXRT1020_ETH_IRQ_GROUP_PRIORITY
   #define MIMXRT1020_ETH_IRQ_GROUP_PRIORITY 12
#elif (MIMXRT1020_ETH_IRQ_GROUP_PRIORITY < 0)
   #error MIMXRT1020_ETH_IRQ_GROUP_PRIORITY parameter is not valid
#endif

//Ethernet interrupt subpriority
#ifndef MIMXRT1020_ETH_IRQ_SUB_PRIORITY
...
extern const NicDriver mimxrt1020EthDriver;

//i.MX RT1020 Ethernet MAC related functions
